...
const Projects = ({ data }) => {
  return (
    <div className="group max-w-106 rounded-lg outline-[#FFFFFF] hover:shadow-2xl duration-300 transition-all shadow-gray-300 border border-gray-200 overflow-hidden flex flex-col h-full">
      ...
      <div className="p-4 xs:p-8 flex flex-col flex-grow">
        ...
        <p className="text-gray-900 text-md xxs:text-lg font-semibold pt-1 mb-3 min-h-[3.5rem]">
          {data?.title}
        </p>
        <p
          style={{ lineHeight: "20px", letterSpacing: "0%" }}
          className="text-gray-600 text-xs xxs:text-[14px] text-wrap min-h-[5rem] flex-grow"
        >
          {data?.description}
        </p>
        <a
